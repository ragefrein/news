...
func indexHandler(w http.ResponseWriter, r *http.Request) {
	...
	var endpoint string
	if search.SearchKey == "" {
		endpoint = fmt.Sprintf("https://newsapi.org/v2/top-headlines?pageSize=%d&page=%d&apiKey=%s&sortBy=publishedAt&language=en", 
			pageSize, search.NextPage, apiKey)
	} else {
...
func searchHandler(w http.ResponseWriter, r *http.Request) {
	...
	if search.NextPage < search.TotalPages {
		search.NextPage++
	}
